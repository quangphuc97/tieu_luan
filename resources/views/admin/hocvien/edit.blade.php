...
@section('main-content')
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <form method="post" action="{{ route('hocvien.update', ['id' => $hoc_vien->id_hoc_vien]) }}" enctype="multipart/form-data" onsubmit="return checkForm()">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $hoc_vien->ho_ten}}" id="ho_ten"
                               name="ho_ten" placeholder="Điền họ tên" required>
                    </div>

                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" class="form-control" value="{{ $hoc_vien->username}}" id="username"
                               name="username" placeholder="Điền username" required>
                    </div>

                    <div class="form-group">
                        <label for="password">Password</label>
                        <input type="password" value="{{ $hoc_vien->password}}" class="form-control" id="password"
                               name="password"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" value="{{ $hoc_vien->password}}" class="form-control" id="password1"
                               name="password1"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $hoc_vien->dia_chi}}" id="dia_chi"
                               name="dia_chi" placeholder="Điền địa chỉ" required>
                    </div>

                    <div class="form-group">
                        <label for="sdt">Số điện thoại</label>
                        <input type="text" class="form-control" value="{{$hoc_vien->sdt}}" id="sdt"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $hoc_vien->email}}" id="email"
