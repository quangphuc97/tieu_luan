...
@section('main-content')
    <h3 align="center">Chỉnh Sửa Tài Khoản Giáo Viên</h3>
    @if ($errors->any())
    ...
    <div class="col-md-12">
        <div class="box box-primary">
                <form method="post" action="{{ route('giaovien.update', ['id' => $giao_vien->id_giao_vien]) }}" enctype="multipart/form-data" onsubmit="return checkForm()">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $giao_vien->ho_ten}}" id="ho_ten"
                               name="ho_ten" placeholder="Điền họ tên" required>
                    </div>

                    <div class="form-group">
                        <label for="username">Username</label>
                        <input type="text" class="form-control" value="{{ $giao_vien->username}}" id="username"
                               name="username" placeholder="Điền username" required>
                    </div>

                    <div class="form-group">
                        <label for="password">Password</label>
                        <input type="password" value="{{ $giao_vien->password}}" class="form-control" id="password"
                               name="password"
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" value="{{ $giao_vien->password}}" class="form-control" id="password1"
                               name="password1"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $giao_vien->dia_chi}}" id="dia_chi"
                               name="dia_chi" placeholder="Điền địa chỉ" required>
                    </div>

                    <div class="form-group">
                        <label for="sdt">Số điện thoại</label>
                        <input type="text" class="form-control" value="{{$giao_vien->sdt}}" id="sdt"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{ $giao_vien->email}}" id="email"
    ...
    <script>
        $(document).ready(function () {
            $("#hinh_anh").fileinput({
                ...
                initialPreview: [
                    "{{ asset('storage/photos/' . $giao_vien->anh_dai_dien) }}"
                ],
                initialPreviewConfig: [
                    {
                        caption: "{{ $giao_vien->anh_dai_dien }}",
                        size: {{ Storage::exists('public/photos/' . $giao_vien->anh_dai_dien) ? Storage::size('public/photos/' . $giao_vien->anh_dai_dien) : 0 }},
                        width: "120px",
                        url: "{$url}",
                        key: 1
                    },
