...
@section('main-content')
    <div class="taikhoan">
        <div class="container bootstrap snippet">
            ...
            @endforeach
            <div class="row" >
                <div class="col-sm-12"><h2 style="text-align: center">Chỉnh sửa thông tin tài khoản</h2></div>
            </div>
            <div class="row">
                <div class="col-sm-3"><!--left col-->

                    <form class="form" action="{{route('chinh-sua')}}" accept-charset="UTF-8" method="POST" enctype="multipart/form-data" files="true" id="registrationForm" onsubmit="return checkPhoneNumber()">
                        {{ csrf_field() }}
                        <div class="text-center">
                            <div class="col-sm-10">Tên đăng nhập: <h2>{{$hoc_vien->username}}</h2></div>
                ...
                <div class="col-sm-8" style="margin-left: 20px;">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  required="required" class="form-control" name="ho_ten" value="{{$hoc_vien->ho_ten}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  required="required" class="form-control" onchange="return checkPhoneNumber()" id="sdt" name="sdt" value="{{$hoc_vien->sdt}}"  >
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email"  required="required" onchange="return checkmail()" class="form-control" id="email" name="email" value="{{$hoc_vien->email}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"   required="required" class="form-control" name="dia_chi" value="{{$hoc_vien->dia_chi}}">
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane" id="messages">
                            ...
                            <hr>
                            <form class="form" action="{{route('chinh-sua-pass')}}" accept-charset="UTF-8" method="POST" enctype="multipart/form-data" files="true" id="registrationForm" onsubmit="return checkPassWord()">
                                {{ csrf_field() }}
                                <div class="form-group">
